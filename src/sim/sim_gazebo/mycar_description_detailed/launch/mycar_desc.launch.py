...
def generate_launch_description():
    ...
    default_model_path = os.path.join(mycar_description,"urdf",MYCAR_MODEL + "_change.urdf")#这是修改后的三楼urdf小车文件
    ...
    rviz_config = Node(
        package="rviz2",
        executable="rviz2",
        arguments=["-d", os.path.join(mycar_description,"config","description_2.rviz")]
    )
